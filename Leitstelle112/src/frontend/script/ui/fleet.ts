...
export const fleet = new class {
    ...
    async add(identifier: { content: any; title: any; }) {
        ...
        vehicleArray.forEach(async (vehicle: { type: any; crew_min: any; crew_max: any; category: string; price: { use_default_price: any; }; crew: any[]; equipment: { vehicle_specific: any[]; default: { hose: any; scba: any; }; }; }) => {
            ...
            vehicle.crew.forEach((crewMember: { required: any; type_long: any; }) => {
            ...
            vehicle.equipment.vehicle_specific.forEach((kit: undefined) => {
