class genPart {
    ...
    async dialogHead(identifier: string, title: string, container: string) {
        new Promise((resolve, reject) => {
            try {
                ...
                uiButton.addEventListener('click', () => {
                    const dialog = document.getElementById(identifier) as HTMLDialogElement;
                    dialog.close()
                })
    ...
    async addContentToTable(content: string, container: string, contentClass: string) {
        new Promise((resolve, reject) => {
            try {
